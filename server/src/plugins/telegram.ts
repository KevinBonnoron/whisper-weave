import type { Connector, Message, SendMessageOptions, SlashCommandContext } from '@whisper-weave/shared';
import { Telegraf, type Context, type Update } from 'telegraf';
import type { ConnectorCapability, PluginBase, PluginMetadata } from '../types';

export interface TelegramConfig {
  botToken: string;
  /** If set, the bot only replies in these chat IDs (string or number). Otherwise all chats. */
...
export class TelegramPlugin implements PluginBase, ConnectorCapability {
