import type { LLM, LLMGenerateOptions, LLMMessage, LLMResponse, Model } from '@whisper-weave/shared';
...
export class ClaudePlugin implements PluginBase, LLMCapability {
